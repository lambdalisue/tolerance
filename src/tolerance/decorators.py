...
def tolerate(substitute=None, exceptions=None,
    ...
    switch : string, list/tuple, dict, function or None
        ...
        so if ``fail_silently=False`` is specified to the function, the
        function works as noramlly.

        **From Version 0.1.1**, when switch is specified as non functional
        value, :func:`argument_switch_generator` will be called with switch as
        arguments.
